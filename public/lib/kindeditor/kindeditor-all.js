    ...
    _extend(KUploadButton, {
        init: function (options) {
            ...
            var html = [
                ...
                '</span>',
                '<input type="file" class="ke-upload-file" accept="image/*" name="' + fieldName + '" tabindex="-1" />',
                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        if (showLocal && showRemote && tabs && tabs.selectedIndex === 1 || !showRemote) {
                            ...
                            dialog.showLoading(self.lang('uploadLoading'));
                            if (AV && AV.File) {
                                var fileUploadControl = K('.ke-upload-file', dialog.div)[0];
                                if (fileUploadControl.files.length > 0) {
                                    ...
                                    avFile.save().then(function () {
                                        clickFn.call(self, avFile.url(), '', '100%');
                                    });
    ...
    self.plugin.image = {
        edit: function () {
            ...
            self.plugin.imageDialog({
                ...
                imageWidth: img ? img.css('width') : '',
                imageHeight: img ? img.css('height') : '',
